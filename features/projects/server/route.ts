...
const app = new Hono()
   ...
   .get("/:projectId", sessionMiddleware, async (c) => {
      ...
      if (!member) return c.json({ error: "Unouthorized" }, 401);
   ...
   .get("/:projectId/analytics", sessionMiddleware, async (c) => {
      ...
      if (!member) return c.json({ error: "Unauthorize" }, 401);
      ...
      const assignedTaskDiffrences = assignedTaskCount - lastMonthAssignedTasks.total;
      ...
      const incompleteTaskDifferences =
      ...
      const completedTaskDifferences = completedTaskCount - lastMonthCompletedTasks.total;
      ...
      const overdueTaskDifferences = overdueTaskCount - lastMonthOverdueTasks.total;
      ...
      return c.json({
         data: {
            ...
            taskDifference,
            assignedTaskCount,
            assignedTaskDiffrences,
            completedTaskCount,
            completedTaskDifferences,
            incompleteTaskCount,
            incompleteTaskDifferences,
            overdueTaskCount,
            overdueTaskDifferences,
         },
      });
   });
